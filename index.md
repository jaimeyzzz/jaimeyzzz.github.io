...
<section class="section" id="about">
  ...
  <aside class="section__aside">
    <div>
      <div class="aside__num">01.</div>
      <div class="aside__note">On record. A short biography in four lines.</div>
    </div>
  </aside>
</section>
...
<section class="section" id="interests">
  ...
  <aside class="section__aside">
    <div>
      <div class="aside__num">02.</div>
      <div class="aside__note">What I currently spend my hours on.</div>
    </div>
  </aside>
</section>
...
<section class="section" id="lumi">
  <div class="section__main">
    <h2 class="section__title">Lumi.</h2>
  ...
  <aside class="section__aside">
    <div>
      <div class="aside__num">04.</div>
      <div class="aside__note">Industry work. Cloth &amp; hair simulation for the digital human <em>Lumi</em> at miHoYo, 2021–2024.</div>
    </div>
  </aside>
</section>
...
<section class="section" id="games">
  <div class="section__main">
    <h2 class="section__title">Off the record.</h2>

    <p style="color:var(--text-mute); margin: 0 0 22px; font-size: 17px; font-family: 'Crimson Pro', serif;">Outside of work, I&rsquo;m a long-time action-game enthusiast. A few personal milestones I&rsquo;m proud of.</p>
  ...
  <aside class="section__aside">
    <div>
      <div class="aside__num">07.</div>
      <div class="aside__note">A few games I&rsquo;ve been proud of finishing well.</div>
    </div>
  </aside>
</section>
